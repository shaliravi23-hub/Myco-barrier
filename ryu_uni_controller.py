...
class MycoUniversalController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.DETECTION_THRESHOLD = 1000000   # Packets/sec to trigger isolation
        self.STRESS_THRESHOLD = 1000000      # Packets/sec to trigger Proxy (Scout/Box only)
    ...
    def _resource_monitor(self):
        ...
        while True:
            ...
            print(f"{elapsed:.2f}, {cpu}, {ram_mb:.2f}, {self.STRATEGY}, {proxy_status}, {under_attack}",flush=True)
